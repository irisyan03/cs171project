...
f = open('data/IY_data/Playlist1.json')
...
f0 = open("data/IY_data/StreamingHistory0.json", "r")
f1 = open("data/IY_data/StreamingHistory1.json", "r")
f2 = open("data/IY_data/StreamingHistory2.json", "r")
